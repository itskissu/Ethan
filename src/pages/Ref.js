...
const Ref = () => {
  ...
  const handleShare = async () => {
    const shareData = {
      title: "Mine ETX tokens now!",
      // eslint-disable-next-line
      url: `https://t.me/ForexTapBot/tap?startapp=r${id}\n\ `, // Replace with your link
      text: "ETX tokens mining is live! Two is better than one!  Join my squad, and let's double the fun (and earnings 🤑)! Gojo Tap Power Tap! 🚀",
    };
